...
exports.loadDocuments = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
function loadDocuments(directoryPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const files = yield fs_1.default.promises.readdir(directoryPath);
        const documents = yield Promise.all(files.map((file) => __awaiter(this, void 0, void 0, function* () {
